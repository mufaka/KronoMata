...
{
    [TestFixture()]
    public class InMemoryPluginMetaDataDataStoreTests : PluginMetaDataDataStoreTestsBase
    {
        ...
        {
            var inMemoryDataStore = (InMemoryPluginMetaDataDataStore)_provider.PluginMetaDataDataStore;
            ((SQLiteDataStoreBase)inMemoryDataStore.BackingDataStoreProvider.PluginMetaDataDataStore).TruncateTable("PluginMetaData");
        }
    }
}