...
{
    [TestFixture()]
    public class InMemoryPackageDataStoreTests : PackageDataStoreTestsBase
    {
        ...
        {
            var inMemoryDataStore = (InMemoryPackageDataStore)_provider.PackageDataStore;
            ((SQLiteDataStoreBase)inMemoryDataStore.BackingDataStoreProvider.PackageDataStore).TruncateTable("Package");
        }
    }
}