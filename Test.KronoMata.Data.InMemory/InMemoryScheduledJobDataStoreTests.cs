...
{
    [TestFixture()]
    public class InMemoryScheduledJobDataStoreTests : ScheduledJobDataStoreTestsBase
    {
        ...
        {
            var inMemoryDataStore = (InMemoryScheduledJobDataStore)_provider.ScheduledJobDataStore;
            ((SQLiteDataStoreBase)inMemoryDataStore.BackingDataStoreProvider.ScheduledJobDataStore).TruncateTable("ScheduledJob");
        }
    }
}