...
{
    [TestFixture()]
    public class SQLitePluginMetaDataDataStoreTests : PluginMetaDataDataStoreTestsBase
    {
        ...
        {
            ((SQLiteDataStoreBase)_provider.ConfigurationValueDataStore).TruncateTable("PluginMetaData");
        }
    }
}