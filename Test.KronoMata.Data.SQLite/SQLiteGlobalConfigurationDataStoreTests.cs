...
{
    [TestFixture()]
    public class SQLiteGlobalConfigurationDataStoreTests : GlobalConfigurationDataStoreTestsBase
    {
        ...
        {
            ((SQLiteDataStoreBase)_provider.ConfigurationValueDataStore).TruncateTable("GlobalConfiguration");
        }
    }
}
